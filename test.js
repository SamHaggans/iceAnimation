...
describe('Test of STATE module', function() {
  ...
  it('STATE.updateCurrentDate() correctly updates the currentDate moment object', function() {
    STATE.updateCurrentDate({'year': 2000});
    let currentDate = STATE.getProp('currentDate');
    assert(currentDate.year() == 2000);
  });

  it('STATE.addToCurrentDate() correctly adds to and updates the currentDate moment object', function() {
    STATE.updateCurrentDate({'year': 2000});
  ...
  it('STATE.subtractFromCurrentDate() correctly subtracts from and updates the currentDate moment object', function() {
    STATE.updateCurrentDate({'year': 2000});
